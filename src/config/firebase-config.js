...
import { getFirestore, setDoc, doc,where, getDocs,query,collection, getDoc,addDoc } from "firebase/firestore";
...
export { auth, db, setDoc, doc, where,getDocs,query,collection, getDoc,addDoc };